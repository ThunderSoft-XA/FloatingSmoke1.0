...
Start date: September 23th, 2019.


Function description:

Develop a demonstration application to display a floating smoke model using Adreno GPU SDK.
...
===>fluid.cpp:   Floating smoke source code cpp file.

===>fluid.h:   Floating smoke source code header file.
...
1、Download code from github according to the repository from　“https://github.com/ThunderSoft-XA/FloatingSmoke1.0.git”.
